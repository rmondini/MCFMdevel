...
FFLAGS 	= -Wall -Wunused-variable -fno-f2c -ffixed-line-length-none $(OMPFLAG) -O2 -I$(INCPATH) -I$(MPIDUMMY) -I$(TENSORREDDIR)/Include -I$(OBJNAME)
...
DIRS	=	$(MCFMHOME):\
		...
		$(SOURCEDIR)/Wgam:$(SOURCEDIR)/Wgamgam:$(SOURCEDIR)/Zgam:\
                $(SOURCEDIR)/Z2jet:$(SOURCEDIR)/Z2jetFloop:$(SOURCEDIR)/Zb:\
		...
		$(SOURCEDIR)/WpmZbj:$(SOURCEDIR)/DM:$(SOURCEDIR)/Monojet:\
                ...
                $(SOURCEDIR)/SCET0j:$(SOURCEDIR)/SCET1j:\
...
qqb_zh_bb_v.o\
qqb_zh_bb_gs.o\
qqb_zh_bb_nlopxd_bc.o\
qqb_zh_bb_nlopxd_bc_v.o\
qqb_zh_bb_nlopxd_ac.o\
qqb_zh_bb_nlopxd_ac_v.o\
qqb_zh_bbg_nlopxd_bc.o\
qqb_zh_bb_nlopxd_bc_gs.o\
qqb_zh_bbg_nlopxd_ac.o\
qqb_zh_bb_nlopxd_ac_gs.o\
...
Finite1x1qqgagas.o \
Finite1x1qqgagau.o \
AGTY_dirgam_assemble_schan.o \
AGTY_dirgam_assemble_uchan.o \
qqb_dirgam_ew.o \
reweightEWvjet.o \
KKPSew.o
...
amp_1gam1g2q.o \
amp_1gam3g.o \
amp_gagg_v_assemble.o \
amp_4qga.o \
amp_4qga_mhvalt.o \
amp_4qga_nf.o \
amp_4qga_v_assemble.o \
amp_del34_gam2j.o \
amp_gaMHV_gam2j.o \
amp_gMHV_gam2j.o \
amp_gMHVadj_gam2j.o \
...
gencuts.o \
gencuts_input.o \
gencuts_ATLAS_gaga.o \
gencuts_ATLAS_gaga2.o \
gencuts_ATLAS_gamjet.o\
gencuts_Zt.o \
gencuts_WZjj.o \
gencuts_VHbb.o\
...
qqbggAxtri123x4x56old.o \
qqbggAxbox3x4x12.o \
qqbggAxbox3x12x4.o \
qqbggAxhardbox.o \
qqbggAxtri3x4c1256.o \
BDKqqbggAxAmp.o \
A6axBDK.o \
Ltfunctions.o \
triangleassemble.o \
...
mcfm$(LIBEXT): $(ALLMCFM)
	...
	@echo $(PDFMSG)
	@echo $(NTUPMSG)
	@echo "   ----> Executable is mcfm$(LIBEXT)$(PDFEXT) <----"
