...
!---to rescale accordingly
      ...
      real(dp) :: mgg,ptgaga,pth,pts,ygh,ygs,ygg,yave,log10pt34
...
c---   llplot:  equal to "lin"/"log" for linear/log scale   
      ...
      call bookplot(n,tag,'mgaga',mgg,wt,wt2,150._dp,1630._dp,40._dp
     &,'log')
      n=n+1
...
!=====ptgaga
      ...
      if (pt34 > zip) then
        log10pt34=log10(pt34)
      else
        log10pt34=-99._dp
      endif
      call bookplot(n,tag,'log10(pt34)',log10pt34,wt
     &     ,wt2,-2._dp,1._dp,0.1_dp,'lin')
      n=n+1
...
! Extra plots
      call bookplot(n,tag,'m34',m34,wt,wt2,200._dp,1600._dp,20._dp,'log')
      n=n+1
