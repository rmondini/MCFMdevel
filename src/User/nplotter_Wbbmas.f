...
c---                1  --> counterterm for real radiation
      ...
      real(dp):: ylept,ptlept,misset,yw,ptw,mw,ybq,ptbq,yba,ptba,
...
************************************************************************
      ...
      if     ((nproc == 20) .or. (nproc == 21)
     &   .or. (nproc == 13)
     &   .or. (nproc == 311) .or. (nproc == 321)
     &   .or. (nproc == 401) .or. (nproc == 402)
     &   .or. (nproc == 403) .or. (nproc == 411)) then
        ilept=4
        inu=3
      elseif ((nproc == 25) .or. (nproc == 26)
     &   .or. (nproc == 18)
     &   .or. (nproc == 316) .or. (nproc == 326)
     &   .or. (nproc == 406) .or. (nproc == 407)
     &   .or. (nproc == 408) .or. (nproc == 416)) then
        ilept=3
        inu=4
      else
