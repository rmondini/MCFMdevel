...
c--- particle pt 
     ...
     &              0._dp,500._dp,10._dp,'lin')
      n=n+1
      call bookplot(n,tag,titlept(ip),var,wt,wt2,
     &              0._dp,5000._dp,50._dp,'lin')
      n=n+1
      call bookplot(n,tag,titlept(ip),var,wt,wt2,
     &              4000._dp,34000._dp,500._dp,'lin')
      n=n+1
...
c--- four-particle invariant mass 
      if (tag == tagbook) then
        var=0._dp
      else
