...
c---   llplot:  equal to "lin"/"log" for linear/log scale   
      ...
      call bookplot(n,tag,'pt(photon)',pt3,wt,wt2,0._dp,150._dp,10._dp,'log')
      n=n+1
      call bookplot(n,tag,'pt(photon)',pt3,wt,wt2,150._dp,1000._dp,50._dp,'log')
      n=n+1
      call bookplot(n,tag,'pt(photon)',pt3,wt,wt2,1000._dp,1400._dp,100._dp,'log')
      n=n+1
      call bookplot(n,tag,'pt(photon)',pt3,wt,wt2,1400._dp,3000._dp,200._dp,'log')
      n=n+1
      call bookplot(n,tag,'pt(photon)',pt3,wt,wt2,3000._dp,6500._dp,3500._dp,'log')
      n=n+1

!      if(usescet) then 
!----- tau 1 for studies, low tau region
!      call bookplot(n,tag,'tauhist low',tauhist,wt,wt2,taucut,
!     &   taucut*10._dp, taucut/2._dp ,'log') 
!      n=n+1
!----- tau 1 overflow
!      call bookplot(n,tag,'tauhist over',tauhist,wt,wt2,
!     &   taucut*10._dp,2000._dp, 100._dp ,'log') 
!      n=n+1
!      endif
...
c--- compute cross-sections in various rapidity ranges
      dsig1=zip
      dsig2=zip
      dsig3=zip
      dsig4=zip
...
!        dsig4=one
!      endif
!      call bookplot(n,tag,'sig1',0.5d0,wt*dsig1,wt2*dsig1,0._dp,1._dp,1._dp,'lin')
!      n=n+1
!      call bookplot(n,tag,'sig2',0.5d0,wt*dsig2,wt2*dsig2,0._dp,1._dp,1._dp,'lin')
!      n=n+1
!      call bookplot(n,tag,'sig3',0.5d0,wt*dsig3,wt2*dsig3,0._dp,1._dp,1._dp,'lin')
!      n=n+1
!      call bookplot(n,tag,'sig4',0.5d0,wt*dsig4,wt2*dsig4,0._dp,1._dp,1._dp,'lin')
!      n=n+1
...
!---- region 1
     ...
     &     ,5._dp,'log')
      call ebookplot(n,tag,ptreg1,wt)
      n=n+1
