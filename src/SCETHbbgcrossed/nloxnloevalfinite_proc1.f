      ...
      subroutine nloxnloevalfinite_proc1(uu,vv,musq,nloxnloeps0) 
      implicit none 
      include 'types.f'
      include 'constants.f'
      include 'nf.f'  
...
!      write(*,*) 'a1finite nloxnlo proc1 = ',a1finite
!      write(*,*) 'a2finite nloxnlo proc1 = ',a2finite
...
!      write(*,*) 'nloxnloeps0 proc1 = ',nloxnloeps0
