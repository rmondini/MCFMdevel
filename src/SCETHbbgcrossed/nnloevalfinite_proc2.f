      ...
      subroutine nnloevalfinite_proc2(uu,vv,musq,nnloeps0) 
      implicit none 
      include 'types.f'
      include 'constants.f'
      include 'nf.f' 
...
!==== MSbar-renormalized coefficients for hard function
      ...
      call nnloevalfinitetdhpla1_proc2(uu,vv,musq,a1finite)
      call nnloevalfinitetdhpla2_proc2(uu,vv,musq,a2finite)

!      write(*,*) 'a1finite nnlo proc2 = ',a1finite
!      write(*,*) 'a2finite nnlo proc2 = ',a2finite
