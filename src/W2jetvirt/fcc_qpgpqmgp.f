      function Fcc_qpgpqmgp(j1,j2,j3,j4,j5,j6,za,zb) 
      implicit none
      include 'types.f'
      complex(dp):: Fcc_qpgpqmgp
     ...
     .(2._dp*L0(-t(j2,j3,j4),-s(j5,j6))*za(j1,j3)*za(j1,j5)*za(j3,j5)*
     .(za(j2,j3)*zb(j1,j2)-za(j3,j4)*zb(j1,j4)))/
     .(s(j5,j6)*za(j1,j2)*za(j1,j4)*za(j2,j3)*za(j3,j4)*za(j5,j6))+
     .(2._dp*L0(-t(j2,j3,j4),-s(j3,j4))*za(j2,j5)*za(j3,j5)*zb(j2,j4))/
     .(s(j3,j4)*za(j1,j2)*za(j2,j4)*za(j5,j6))+
     .(2._dp*L0(-t(j2,j3,j4),-s(j2,j3))*za(j3,j5)*za(j4,j5)*zb(j2,j4))/
