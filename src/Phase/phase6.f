...
c---- with all 2 pi's (ie 1/(2*pi)^14)
     ...
     & p348(4),p567(4),p56(4),p3456(4),p5678(4),tmp(4),p57(4),p68(4)
      real(dp):: wt,wt0,wt12,wt678,wt345,wt34,wt78,wt3456,wt56,
     & wt5678,s34,s56,s36,s45,wt_zz,wt_ww,wt68,wt57
      integer:: j
...
c--- wt_zz must also suppress possible photon pole for Z(34), in addition to BW
     ...
     &   .or. (kcase==kWpmZjj) .or. (kcase==kqqWZqq)) then
      ...
      elseif(kcase==kZHbbjt) then
         ...
         call phi1_2(r(7),r(8),r(11),r(12),p5678,p57,p68,wt5678,*99)
         call phi3m0(r(13),r(14),p57,p5,p7,wt57,*99)
         call phi3m0(r(15),r(16),p68,p6,p8,wt68,*99)
         wt=wt0*wt12*wt34*wt5678*wt57*wt68
         n3=oldn3
         return
