...
!########################################################
      subroutine xbeam2bis(ih,ibeam,zin,xb,QB,btau)
      implicit none
      include 'types.f'
      include 'constants.f'
      include 'nf.f'
...
! calculate parton distribution
      call fdist_select(ih,ibeam,xb,facscale,fx0)
      call fdist_select(ih,ibeam,xb/zb,facscale,fx)
