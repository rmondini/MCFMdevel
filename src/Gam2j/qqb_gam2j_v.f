...
!$omp threadprivate(/mqq/,/rvcolourchoice/)
     ...
     &     ,qbqb_v1_b(2,2,2),qbqb_v2_b(2,2,2)
      ...
      integer j1,j2,j3
      real(dp) :: qqb_gagg_nf,qg_gaqg_nf,gq_gaqg_nf,gg_gaqqb_nf
     &,qbq_gagg_nf,qbg_gaqbg_nf,gqb_gaqbg_nf
      complex(dp):: kctest1(2,2,2),kctest2(2,2,2),kctest3(2,2,2)
     &     ,kctest4(2,2,2)
...
!      call amp_qqbggga_v_34_assemble(1,2,3,4,5,za,zb
!     &     ,kctest1,kctest2)
       call ga_qqbQQb_v(1,2,3,4,5,za,zb
     &     ,kctest1,kctest2,kctest3,kctest4)
!      call amp_qqbQQbga_v_assemble(1,2,3,4,5,za,zb,kctest1,kctest2)
      stop
      endif
...
!----- CW like LO, should adjust these names
      ...
      call qqbgg_ga_v(5,4,1,2,3,za,zb,gg_gaqqb,gg_gaqqb_nf)
      ...
      gg_gaqqb_nf=avegg*fac*gg_gaqqb_nf
...
!---- assemble gg pieces
      ...
      do k=-nf,nf
         ...
         if     ((j == 0) .and. (k == 0)) then
            msqv(j,k)=Qsum_all*gg_gaqqb+Qsum_lin*gg_gaqqb_nf
