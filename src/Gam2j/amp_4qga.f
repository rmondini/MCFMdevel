...
!      write(6,*) 
!      write(6,*) 'box 1',boxcoeff(1)*(s(i2,i3)*s(i3,i4))/2._dp*im
!      write(6,*) 'box 2',boxcoeff(2)*(s(i1,i4)*s(i3,i4))/2._dp*im
!      write(6,*) 'box 3',boxcoeff(3)*(s(i2,i5)*s(i2,i3))/2._dp*im
!      write(6,*) 'box 3',boxcoeff(4)*(s(i1,i4)*s(i1,i5))/2._dp*im
      Boxes=czip
      do i=1,4
...
!      write(6,*) 'total ', amp_qqbQQbga_del1_slc*im
!      write(6,*) 'pole pieces',Vpole*im
!      write(6,*) 'boxes ',Boxes*im
!      write(6,*) 'bubs ',Bubs*im
!      write(6,*) 'completed rat',rat*im
!      write(6,*) 'total/LO',amp_qqbQQbga_del1_slc*im/ALO
...
!      write(6,*) 'bubs ',Bubs*im
!      write(6,*) 'completed rat',rat*im
!      write(6,*) 'total/LO',amp_qqbQQbga_del2_slc*im/ALO
...
!      write(6,*) boxcoeff(1)*s(i2,i4)*s(i3,i4)*im/2.
!      write(6,*) boxcoeff(2)*s(i1,i3)*s(i3,i4)*im/2.
!      write(6,*) boxcoeff(3)*s(i1,i5)*s(i1,i3)*im/2.
!      write(6,*) boxcoeff(4)*s(i2,i4)*s(i2,i5)*im/2.
...
!      write(6,*) 'total ', amp_qqbQQbga_del2_lc*im
!      write(6,*) 'pole pieces',Vpole*im
!      write(6,*) 'boxes ',Boxes*im
!      write(6,*) 'bubs ',Bubs*im
!      write(6,*) 'completed rat',rat*im
!      write(6,*) 'total/LO',amp_qqbQQbga_del2_lc*im/ALO
