...
!==== log(mh2omu2)^0 coefficient      
      nloeps0(0) = (6*pi**2*xx**2 + 16*cf*Nc*pi**2*xx**2 + 4*xx*yy + 
     -    4*cf*Nc*xx*yy + 6*pi**2*xx*yy + 16*cf*Nc*pi**2*xx*yy + 
     -    3*pi**2*yy**2 + 8*cf*Nc*pi**2*yy**2 + 4*xx*zz + 
     -    4*cf*Nc*xx*zz + 6*pi**2*xx*zz + 16*cf*Nc*pi**2*xx*zz + 
     -    6*pi**2*yy*zz + 16*cf*Nc*pi**2*yy*zz + 3*pi**2*zz**2 + 
     -    8*cf*Nc*pi**2*zz**2 - 
