* Minimal modifications by John Campbell, October 2015
* to ensure smaller memory footprint that is better for MPI
*
* 1) Introduced parameter imaxrep=1 (original corresponds to =100)
* 2) Limited grid read-in to imaxrep rather than mem
* 3) Added mpicommon.f include file to reduce output
*
***
*
...
*            
      read(20,*) line
c---- Modification of upper limit below by JC
c      do imem=0,mem
      do imem=0,imaxrep
         do ix=1,nx
            do iq=1,nq2
