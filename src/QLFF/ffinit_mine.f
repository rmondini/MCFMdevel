...
C	path = '/user/gj/lib/
C	fullname = path(1:index(path,' ')-1)//name
C	MCFM use: Install script creates a symbolic link in Bin directory
	fullname = name
