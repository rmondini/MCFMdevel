...
C---Indices of xpp etc are xpp(h3,h5) 
     ...
     & tmpa(2,2),tmpb(2,2),
     & Xrat(2,2,2,2),Xrats(2,2,2,2),crat(2,2,2,2,6),drat(2,2,2,2,3),
...
!     & Xrat)
      call ZZtri1_2LL(k1,k2,k3,k4,k5,k6,za,zb,mt,xapp,xamp,tmpa,tmpb,
     & Xrat)
      call ZZtri1_2LL(k1,k2,k3,k4,k5,k6,zb,za,mt,xamm,xapm,tmpa,tmpb,
     & Xrats)
      call ZZswapcoeff(xamm,xapm,Xrat,Xrats)
      CLL(c1_2,1,1,:,:)=xamm(:,:)
      CLL(c1_2,1,2,:,:)=xamp(:,:)
      CLL(c1_2,2,1,:,:)=xapm(:,:)
      CLL(c1_2,2,2,:,:)=xapp(:,:)
...
!     & Xrat)
      call ZZtri1_34LL(k1,k2,k3,k4,k5,k6,za,zb,mt,xapp,xamp,tmpa,tmpb,
     & Xrat)
      call ZZtri1_34LL(k1,k2,k3,k4,k5,k6,zb,za,mt,xamm,xapm,tmpa,tmpb,
     & Xrats)
      call ZZswapcoeff(xamm,xapm,Xrat,Xrats)
...
!     & Xrat)
      call ZZtri1_34LL(k1,k2,k5,k6,k3,k4,za,zb,mt,xapp,xamp,tmpa,tmpb,
     & Xrat)
      call ZZtri1_34LL(k1,k2,k5,k6,k3,k4,zb,za,mt,xamm,xapm,tmpa,tmpb,
     & Xrats)
      call ZZswapcoeff(xamm,xapm,Xrat,Xrats)
c      write(6,*) 'Xapp(1,1)',Xapp(1,1)
c      write(6,*) 'Xamp(1,1)',Xamp(1,1)
...
!     & Xrat)
      call ZZtri1_34LL(k2,k1,k3,k4,k5,k6,za,zb,mt,xapp,xapm,tmpa,tmpb,
     & Xrat)
      call ZZtri1_34LL(k2,k1,k3,k4,k5,k6,zb,za,mt,xamm,xamp,tmpa,tmpb,
     & Xrats)
      call ZZswapcoeff(xamm,xamp,Xrat,Xrats)
c      write(6,*) 'Xapp(1,1)',Xapp(1,1)
c      write(6,*) 'Xamp(1,1)',Xamp(1,1)
      CLL(c2_34,1,1,:,:)=xamm(:,:)
      CLL(c2_34,1,2,:,:)=xamp(:,:)
...
!     & Xrat)
      call ZZtri1_34LL(k2,k1,k5,k6,k3,k4,za,zb,mt,xapp,xapm,tmpa,tmpb,
     & Xrat)
      call ZZtri1_34LL(k2,k1,k5,k6,k3,k4,zb,za,mt,xamm,xamp,tmpa,tmpb,
     & Xrats)
      call ZZswapcoeff(xamm,xamp,Xrat,Xrats)
c      write(6,*) 'Xapp(1,1)',Xapp(1,1)
c      write(6,*) 'Xamp(1,1)',Xamp(1,1)
...
!      call ZZtri12_34LL(k1,k2,k3,k4,k5,k6,za,zb,mt,xapp,xamp,xapm,xamm)
      call ZZtri12_34LL(k1,k2,k3,k4,k5,k6,za,zb,mt,xapp,xamp,tmpa,tmpb)
      call ZZtri12_34LL(k1,k2,k3,k4,k5,k6,zb,za,mt,xamm,xapm,tmpa,tmpb)
      call ZZswapcoeff(xamm,xapm,Xrat,Xrats)
c      pause
