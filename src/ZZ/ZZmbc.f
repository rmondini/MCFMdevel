...
C     &    j1,j3,j4,j2)*s(j1,j2) - 3.D0*zba2(j4,j1,j2,j3)*zba2(j2,j3,j4,
C     &    j1)*zba2(j6,j1,j2,j5)/zba2(j1,j3,j4,j2)*s(j5,j6) - 3.D0*
C     &    zba2(j4,j1,j2,j3)*zba2(j2,j5,j6,j1)*zba2(j6,j1,j2,j5)/zba2(
C     &    j1,j5,j6,j2)*s(j3,j4) + 3.D0*zba2(j4,j1,j2,j3)*zba2(j2,j5,j6,
C     &    j1)*zba2(j6,j1,j2,j5)/zba2(j1,j5,j6,j2)*s(j1,j2) + 3.D0*
C     &    zba2(j4,j1,j2,j3)*zba2(j2,j5,j6,j1)*zba2(j6,j1,j2,j5)/zba2(
C     &    j1,j5,j6,j2)*s(j5,j6) + 3.D0*zba2(j4,j1,j2,j3)*zba2(j2,j4,j3,
C     &    j1)*zba2(j6,j1,j2,j5)/zab2(j2,j3,j4,j1)*s(j3,j4) + 3.D0*
C     &    zba2(j4,j1,j2,j3)*zba2(j2,j4,j3,j1)*zba2(j6,j1,j2,j5)/zba2(
C     &    j1,j4,j3,j2)*s(j1,j2) - 3.D0*zba2(j4,j1,j2,j3)*zba2(j2,j4,j3,
C     &    j1)*zba2(j6,j1,j2,j5)/zab2(j2,j3,j4,j1)*s(j5,j6) - 3.D0*
C     &    zba2(j4,j1,j2,j3)*zba2(j2,j6,j5,j1)*zba2(j6,j1,j2,j5)/zba2(
C     &    j1,j6,j5,j2)*s(j3,j4) )
C     & + IDelta**2 * ( 3.D0*zba2(j4,j2,j1,
C     &    j3)*zba2(j2,j6,j5,j1)*zba2(j6,j1,j2,j5)/zba2(j1,j6,j5,j2)*s(
C     &    j1,j2) + 3.D0*zba2(j4,j1,j2,j3)*zba2(j2,j6,j5,j1)*zba2(j6,j2,
