...
c      logical:: ggZZunstable
     ...
     & totrat(2,2,2,2),tmp,bsave(2,2,2,2,7)
      real(dp):: mt
...
c      s56=s(j5,j6)
      ...
      do h1=1,2
      do h2=1,2
! Cannot do this any longer when crossing, need explicit za<->zb
...
!      if ((h1==2) .and. (h2==2)) st='q+qb-g+g+' 
      ...
      if (st == 'q+qb-g-g-') then
          ...
          if (h2 == 2) then
            ...
            call ZZmbc(st1,k2,k1,k4,k3,k6,k5,za,zb,bcoeff)
          endif
...
c      stop
      ...
      elseif (st=='q+qb-g-g+') then
          if (h2 == 2) then
            ...
            call ZZmbc(st,k1,k2,k3,k4,k5,k6,zb,za,bcoeff)
          endif
...
c      stop
      ...
      elseif (st=='q+qb-g+g-') then
          ...
          if (h2 == 2) then
            ...
            call ZZmbc(st1,k1,k2,k4,k3,k6,k5,za,zb,bcoeff)
          endif
c--- (+,-) amplitudes
c      write(6,*) 'old:+-'
c      write(6,*) 'bcoeff(b34)',
...
c      pause
      ...
      if (h2 == 2) then
        ...
        b(3-h1,h2,3-h3,3-h4,j)=bcoeff(j)
      endif
      enddo
