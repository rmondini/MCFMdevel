     ...
     & Xrat(2,2,2,2),Xrats(2,2,2,2),drat(2,2,2,2,3),tmpa(2,2),tmpb(2,2)
      
!      call ZZbox2LL(j1,j2,j3,j4,j5,j6,za,zb,mt,Xpp,Xmp,Xpm,Xmm,Xrat)
      call ZZbox2LL(j1,j2,j3,j4,j5,j6,za,zb,mt,Xpp,Xmp,tmpa,tmpb,Xrat)
      call ZZbox2LL(j1,j2,j3,j4,j5,j6,zb,za,mt,Xmm,Xpm,tmpa,tmpb,Xrats)
      call ZZswapcoeff(Xmm,Xpm,Xrat,Xrats)
      d(2,2,:,:,d2_1_34)=Xpp(:,:)
      d(1,2,:,:,d2_1_34)=Xmp(:,:)
      d(2,1,:,:,d2_1_34)=Xpm(:,:)
      d(1,1,:,:,d2_1_34)=Xmm(:,:)
...
!      call ZZbox2LL(j1,j2,j5,j6,j3,j4,za,zb,mt,Xpp,Xmp,Xpm,Xmm,Xrat)
      call ZZbox2LL(j1,j2,j5,j6,j3,j4,za,zb,mt,Xpp,Xmp,tmpa,tmpb,Xrat)
      call ZZbox2LL(j1,j2,j5,j6,j3,j4,zb,za,mt,Xmm,Xpm,tmpa,tmpb,Xrats)
      call ZZswapcoeff(Xmm,Xpm,Xrat,Xrats)
      d(2,2,:,:,d1_2_34)=Xpp(:,:)
      d(1,2,:,:,d1_2_34)=Xmp(:,:)
      d(2,1,:,:,d1_2_34)=Xpm(:,:)
...
!      call ZZbox1LL(j1,j2,j3,j4,j5,j6,za,zb,mt,Xpp,Xmp,Xpm,Xmm,Xrat)
      call ZZbox1LL(j1,j2,j3,j4,j5,j6,za,zb,mt,Xpp,Xmp,tmpa,tmpb,Xrat)
      call ZZbox1LL(j1,j2,j3,j4,j5,j6,zb,za,mt,Xmm,Xpm,tmpa,tmpb,Xrats)
      call ZZswapcoeff(Xmm,Xpm,Xrat,Xrats)
      d(2,2,:,:,d1_34_2)=Xpp(:,:)
      d(1,2,:,:,d1_34_2)=Xmp(:,:)
      d(2,1,:,:,d1_34_2)=Xpm(:,:)
