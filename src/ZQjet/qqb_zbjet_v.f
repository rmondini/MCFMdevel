...
************************************************************************
     ...
     & p(mxpart,4),pswap(mxpart,4),fac
      complex(dp):: atreez,a61z,a63z,prop,vcouple(2),tcouple(2),tamp,lamp,
     & mmsq_gq_vec0(2,2),mmsq_gq_vect(2,2),mmsq_gq_ax(2,2),
     & mmsq_qg_vec0(2,2),mmsq_qg_vect(2,2),mmsq_qg_ax(2,2),
     & mmsq_qbg_vec0(2,2),mmsq_qbg_vect(2,2),mmsq_qbg_ax(2,2),
     & mmsq_gqb_vec0(2,2),mmsq_gqb_vect(2,2),mmsq_gqb_ax(2,2)
...
CALL    0--> q(p5)+g(p6)+g(p1)+qb(p2)+lbar(p4)+l(p3)
      ...
      call xzqqgg_v(pswap,mmsq_gq,mmsq_gq_vec0,mmsq_gq_vect,mmsq_gq_ax)
...
CALL    0--> q(p5)+g(p6)+g(p2)+qb(p1)+lbar(p4)+l(p3)
      ...
      enddo
      call spinoru(6,pswap,za,zb)
      call xzqqgg_v(pswap,mmsq_qg,mmsq_qg_vec0,mmsq_qg_vect,mmsq_qg_ax)
