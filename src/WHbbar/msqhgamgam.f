...
c--- account for anomalous couplings if necessary
c--- (note: should be chi^2, but we include chi^4 to account for prodution
c---        too, since this is a shortcut for ggfus0 process only ...)
      if (anom_higgs) then
        msqhgamgam=msqhgamgam*chi_higgs**4
      endif
