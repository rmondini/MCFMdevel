      subroutine qqb_zh_bb_nlopxd_ac_gs(p,msq)
      implicit none
      include 'types.f'
...
c                           ---> b(p5)+bb(p6)
     ...
     & sub17_2(4),sub27_1(4),dummyv(-nf:nf,-nf:nf),dsubv
      external qqb_zh_bb_nlopxd_ac,donothing_gvec
...
c---- entries are left as dummies
      call dips(1,p,1,8,2,sub17_2,dsubv,msq17_2,dummyv,
     & qqb_zh_bb_nlopxd_ac,donothing_gvec)
      call dips(2,p,2,8,1,sub27_1,dsubv,msq27_1,dummyv,
     & qqb_zh_bb_nlopxd_ac,donothing_gvec)
