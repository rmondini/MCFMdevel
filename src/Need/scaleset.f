...
c--- upgraded 3/2016 to convert string to integer on first call, for speed
     ...
     & km34sqsumptjsq=13,kptphoton=14,kHT=15,kddis=16,kmVpmH=17,kshat=18,kMsqpt3sq=19
...
!$omp end master
     ...
     &     .or. (dynstring == 'Mt') .or. (dynstring == 'MT')) then
        ...
        elseif (dynstring == 'sqrt(M^2+pt3^2)') then
          scaleindex=kMsqpt3sq
...
! Set scale
      ...
      elseif (scaleindex == kMsqpt3sq) then
        call scaleset_Msqpt3sq(p,mu0)
