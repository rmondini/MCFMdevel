...
c   contracted with the vector n(mu)
      ...
      integer:: j1,j2,j5
      real(dp):: Asq,p(mxpart,4),n(4),nDn,nDp1,nDp2,dot,s,t,u,ggHexpand
      ...
      Asq=(as/(three*pi))**2/vevsq*ggHexpand(Wilsonorder)
...
c   contracted with the vector n(mu)
      ...
      include 'expansionorder.f'
      integer:: j1,j2,j5
      real(dp):: Asq,p(mxpart,4),n(4),nDn,nDp1,nDp2,dot,s,t,u,sh,ggHexpand
